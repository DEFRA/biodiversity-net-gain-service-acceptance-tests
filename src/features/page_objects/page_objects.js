...
const CreditsMetricUploadPage = require('./credits-purchase/upload-metric-file.page.js')
...
const CombinedCaseLegalAgreementCCUploadPage = require('./combined_case/legal_agreement/upload-legal-agreement-cc.page.js')
const CombinedCaseLegalAgreementCheckFileCCPage = require('./combined_case/legal_agreement/check-legal-agreement-file-cc.page.js')
...
const CombinedCaseDeveloperMetricUploadPage = require('./combined_case/developer/upload-metric-file.page.js')
const CombinedCaseDeveloperCheckMetricUploadPage = require('./combined_case/developer/check-metric-file.page.js')
const CombinedCaseCheckAndSubmitPage = require('./combined_case/check-and-submit.page.js')
const CombinedCaseUploadPlanningDecisionNoticePage = require('./combined_case/developer/upload-planning-decision-notice.page.js')
const CombinedCaseCheckPlanningDecisionNoticePage = require('./combined_case/developer/upload-planning-decision-notice-check.page.js')
...
module.exports = {
  ...
  'habitat-plan-legal-agreement': new HabitatPlanLegalAgreementPage(),
  ...
  'credits-purchase-metric-upload': new CreditsMetricUploadPage(),
  ...
  'credits-purchase-tasklist': new CreditsPurchaseTaskListPage(),
  ...
  'combined-case-legal-agreement-cc-upload': new CombinedCaseLegalAgreementCCUploadPage(),
  'combined-case-legal-agreement-check': new CombinedCaseLegalAgreementCheckFileCCPage(),
  ...
  'combined-case-project-details': new CombinedCaseDeveloperJourneyDevelopmentInformationPage(),
  'combined-case-check-and-submit': new CombinedCaseCheckAndSubmitPage(),
  'combined-case-upload-planning-decision-notice': new CombinedCaseUploadPlanningDecisionNoticePage(),
  'combined-case-check-planning-decision-notice-file': new CombinedCaseCheckPlanningDecisionNoticePage(),
