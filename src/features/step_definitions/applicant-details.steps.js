...
import applicantDetailsCheckYourDetailsPage from "../page_objects/applicant_details/check-your-details.page";
...
Then(/^I should see the "(.*)" (?:shown as|updated to) "(.*)" on the check-your-details page$/, async (option, value) => {
  switch (option) {
    case "fullname": {
