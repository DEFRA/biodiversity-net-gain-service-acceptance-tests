...
function setUploadPagesForDocument (document) {
  switch (document) {
    ...
    case "combined-case-legal-agreement": {
      return{
        UploadPage: pages['combined-case-legal-agreement-cc-upload'],
        CheckPage: pages['combined-case-legal-agreement-check']
      }}
    case 'combined-case-local-land-charge': {
      ...
      case 'combined-case-planning-decision-notice':{
        return {
          UploadPage: pages['combined-case-upload-planning-decision-notice'],
          CheckPage: pages['combined-case-check-planning-decision-notice-file']
        }
      }
...
async function uploadFileForDocument (UploadPage, filePath) {
  ...
  await UploadPage.govFileUpload.waitForExist({ timeout: 5000 })
